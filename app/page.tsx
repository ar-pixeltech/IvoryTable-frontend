...
import { CheckCircle, ShoppingCart, BarChart3, CreditCard, Store } from 'lucide-react';
...
export default function Home() {
  return (
    <div className="bg-white text-gray-800">
      {/* Hero Section */}
      <section
        className={`min-h-screen flex items-center justify-center bg-gradient-to-r ${brandConfig.gradientFrom} ${brandConfig.gradientTo} text-white px-6`}
      >
        <div className="max-w-6xl text-center">
          <h1 className="text-5xl font-bold leading-tight">{brandConfig.tagline}</h1>

          <p className="mt-6 text-lg opacity-90">
            IvoryTable helps restaurants, retail stores & cafes manage billing, GST, inventory and
      ...
      <section className="py-20 px-6 bg-gray-50">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-12">Powerful Features Built for India</h2>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
          <div>
            <h2 className="text-3xl font-bold mb-6">Everything You Need To Run Your Store</h2>
          ...
          <div className={`bg-${brandConfig.primaryColor}-100 p-10 rounded-2xl shadow-sm`}>
            ...
            <h3 className="text-xl font-semibold mb-3">Built for Restaurants & Retail</h3>
            <p className="text-gray-700">
              Whether you run a small cafe or a growing retail store, IvoryTable scales with your
              business.
            </p>
          </div>
        </div>
      ...
      <section className="py-20 bg-gray-900 text-white px-6">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-12">How IvoryTable Works</h2>
      ...
      <section className="py-20 text-center px-6">
        <h2 className="text-4xl font-bold mb-6">Ready to Simplify Your Business?</h2>
...
function StepCard({ step, title, description }: any) {
  return (
    <div className="bg-gray-800 p-8 rounded-2xl">
      <div className={`text-${brandConfig.primaryColor}-400 text-2xl font-bold mb-4`}>{step}</div>
      <h3 className="text-xl font-semibold mb-3">{title}</h3>
