    ...
    <div className="space-y-8">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500 text-sm">Revenue insights & order management</p>
        </div>
          ...
          {['today', '7d', '30d'].map((r) => (
            <button
              ...
              className={`px-3 py-1 text-sm rounded-md transition
                ${range === r ? 'bg-emerald-600 text-white' : 'hover:bg-gray-100'}
              `}
            >
          ...
          <div className="space-y-4">
            {topProducts.map((item, index) => (
              <div key={index} className="flex justify-between items-center border-b pb-2">
                ...
                <span className="text-emerald-600 font-semibold">₹{item.revenue}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      {selectedOrder && (
        <div className="fixed inset-0 bg-black/20 flex justify-end z-50">
          <div className="w-96 bg-white h-full shadow-xl p-6 space-y-6 overflow-y-auto animate-slide-in">
            <div className="flex justify-between items-center">
              <h2 className="font-semibold text-lg">{selectedOrder.id}</h2>
